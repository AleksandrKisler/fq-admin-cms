  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-100">
    <el-card class="w-full max-w-sm">
      ...
      <el-form :model="form" :rules="rules" ref="formRef" label-width="0">
        ...
        <el-form-item><el-button type="primary" :loading="loading" @click="submit">Войти</el-button></el-form-item>
      </el-form>
    </el-card>
  </div>
</template>
...
const loading = ref(false); const formRef = ref<FormInstance>();
...
const submit = async () => {
  ...
  try {
    ...
    token.value = res.token; await navigateTo('/admin');
  } catch { ElMessage.error('Неверные учётные данные'); }
