        ...
        <AdminFormSection title="Основное">
          <el-form ref="formRef" :model="form" :rules="rules" label-position="top" class="grid gap-4">
            ...
            <div class="grid md:grid-cols-2 gap-4">
              <el-form-item label="Тема письма" prop="subject">
                <el-input v-model="form.subject"/>
              </el-form-item>
              <el-form-item label="Preheader">
                <el-input v-model="form.preheader"/>
              </el-form-item>
            </div>
            <div class="grid md:grid-cols-2 gap-4">
              <el-form-item label="От кого">
                <el-input v-model="form.from_name" placeholder="Forever Queen"/>
              </el-form-item>
              <el-form-item label="Email отправителя">
                <el-input v-model="form.from_email" placeholder="hello@foreverqueen.ru"/>
              </el-form-item>
            </div>
      ...
      <div class="lg:col-span-5 space-y-6">
        ...
        <AdminFormSection title="Действия">
          <div class="flex items-center gap-2">
            <el-button type="success" plain @click="save">Отправить</el-button>
          </div>
...
const save = async () => {
  ...
  try {
    ...
    ElMessage.success('Отправка письма успешна')
  } catch {
